<div href="#" class="trick-card {{ $trick->draft ? 'draft' : '' }} col-lg-4 col-md-6 col-sm-6 col-xs-12">
	<div class="trick-card-inner js-goto-trick" data-slug="{{ $trick->id . '-' . $trick->slug }}">
		<a class="trick-card-title" href="{{ route('tricks.show', [$trick->id, $trick->slug]) }}">
			{{{ $trick->title }}}
		</a>
		...
		<div class="trick-card-stats clearfix">
			...
			<div class="trick-card-stat-block text-center"><span class="fa fa-comment"></span> <a href="{{ route('tricks.show', [$trick->id, $trick->slug]) . '#disqus_thread' }}" data-disqus-identifier="{{$trick->id}}">0</a></div>
